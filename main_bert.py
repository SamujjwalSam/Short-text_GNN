...
from config import configuration as cfg, dataset_dir, platform as plat, pretrain_dir, username as user
...
for pepoch in pepochs:
    if cfg['data']['use_all_data']:
        ...
        BERT_multilabel_classifier(
            ...
            dataset_name=args.dataset_name, model_name=args.model_name,
            model_type=args.model_type, num_epoch=args.num_train_epochs,
            use_cuda=args.use_cuda, exp_name='BERT_GCPD_zeroshot_'+str(pepoch),
